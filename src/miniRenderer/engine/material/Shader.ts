...
class Shader {
	private mVtxGLSL = `#version 300 es
...
`;
	private mFragGLSL = `#version 300 es
...
`;
	...
	constructor(vtxGLSL = '', fragGLSL = '', uuid = '', params: any = null) {
	...
	initialize(vtxGLSL: string, fragGLSL: string, uuid = '', params: any = null): void {
		this.mVtxGLSL = vtxGLSL;
		this.mFragGLSL = fragGLSL;
		this.mDirty = this.mProgUUID !== uuid;
		this.mParam = params;
	}
	buildGpuRes(gl: any | null, params: any | null = null): void {
		params = params || this.mParam;
